...
export default function FloatingButtons({ Config }: { Config: Array<any> }) {
  ...
  const socialLinks = [
    {
      id: "zalo",
      name: "Chat Zalo",
      href: SocialMedia?.zalo ? SocialMedia.zalo : "https://zalo.me",
      image:
    ...
    },
    {
      id: "facebook",
      name: "Facebook",
      href: SocialMedia?.fanpage ? SocialMedia.fanpage : "https://facebook.com",
      image:
