...
const processSteps = [
  {
    ...
    description: 'Lắng nghe nhu cầu và ghi nhận tình trạng ban đầu của thú cưng.',
  },
  {
    title: 'Thăm khám và tư vấn',
    description: 'Kiểm tra tình trạng và giải thích các bước cần thiết bằng cách dễ hiểu.',
  },
  {
    title: 'Trao đổi phương án',
    description: 'Phương án và chi phí dự kiến được trao đổi trước khi thực hiện.',
  },
  {
    title: 'Hướng dẫn theo dõi',
    description: 'Chủ nuôi nhận hướng dẫn chăm sóc và các dấu hiệu cần lưu ý tại nhà.',
  },
]
